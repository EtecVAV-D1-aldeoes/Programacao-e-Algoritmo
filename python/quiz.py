...
#funçao para selecionar as 20 perguntas
def jogar_quiz():
    pontuacao = 0
    print("\n===== QUIZ =====\n")
...
while True:
    ...
    if resposta == "1":      
        ...
        regras = print("Serão 20 perguntas sobre arduíno, com alternativas A, B, C, D e E respectivamente.\nEscolha a resposta correta e digite a alternativa.\nPontos\nCada questâo vale 0,5 pontos, acerte as 20 e alcance a pontuação nota:10")
    elif resposta == "3":
